module.exports = {
    ...
    help: ["The most commonly used commands are:", "clear", "clear screen", "quit", "exit dragon quest", "restart", "resets the game", "go back", "goes back to the last question, down to the first", "login (name)", "jumps to where you last died",
        ],

    intro: [
        [
      "Welcome to DragonScript", "Type help for assistance.", "", "Drawing your sword was a bold move. The dragon feels threatened! It launches at you with fiery breath and sharp pointies.", "What do you do?", "[a] blindly swing your to the dragon's throat", "[b] run away!!", "[c] pray for mercy"
      ],
    ...
    quotes: ["Haha, you must be kidding", "We all make mistakes, try again", "Your life is in danger, take this seriously", "you call yourself a programmer?", "That can't be right", "I might be a dragon, but I don't think that's right", "Take your time human, try again"]
}
